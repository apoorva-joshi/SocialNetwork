...
private static final Logger logger = LoggerFactory.getLogger(LoginController.class);
	...
	public String updateProfilePic(Model model, Person person, HttpServletRequest request)
	{
		...
		File localFile = new File("C:\\Users\\Apoorva\\Documents\\workspace-sts-3.6.4.RELEASE\\Hoppipolla\\src\\main\\webapp\\resources\\assets\\img\\profile\\", person.getProfilePic().getOriginalFilename());
		try {
